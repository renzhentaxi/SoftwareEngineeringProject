...
public interface IAssignment {
     ...
     * @param student   the account whos grade for this assignment is being entered
     ...
     * @param student   the student whos grade is to be cleared
     * @throws NotAStudentException  if the student is not a sutdent of this course
     ...
     *
     * @param requester the user who modies the grade
     * @param student   the studen't whose grade is to be modified
     ...
     * @param student   the student whos grade is being requested
